...
public class Newactivityadapter extends BaseAdapter {
	...
	public Newactivityadapter(Context c) {
		mContext = c;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) { // if it's not recycled, initialize some
			...
			imageView.setLayoutParams(new GridView.LayoutParams(110, 70));
	...
	private String[] mThumbIds = { "Walk", "Run", "Bike",
			"Sports!", "Gym!", "Outdoors!","Dance","Couch Potatoe","Aditional Activities"
			  };
}