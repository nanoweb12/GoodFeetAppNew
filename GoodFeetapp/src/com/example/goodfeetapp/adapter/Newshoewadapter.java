...
public class Newshoewadapter extends BaseAdapter {
	...
	public Newshoewadapter(Context c) {
		mContext = c;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) { // if it's not recycled, initialize some
			...
			imageView.setLayoutParams(new GridView.LayoutParams(110, 65));
	...
	private String[] mThumbIds = { "Athletic", "Dress", "Oxford",
			"Boots!", "Sandals!", "Additional Styles!"
			  };
}